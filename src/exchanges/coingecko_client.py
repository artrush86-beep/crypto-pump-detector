...
class CoinGeckoClient:
    ...
    def map_to_futures_symbol(self, symbol: str) -> str:
        ...
        special_cases = {
            ...
            # Top 50+ altcoins for futures
            "PEPE": "PEPEUSDT", "SHIB": "SHIBUSDT", "WIF": "WIFUSDT",
            "BONK": "BONKUSDT", "FLOKI": "FLOKIUSDT", "DOGS": "DOGSUSDT",
            "MEW": "MEWUSDT", "POPCAT": "POPCATUSDT", "MOG": "MOGUSDT",
            "BOME": "BOMEUSDT", "BRETT": "BRETTUSDT", "SLERF": "SLERFUSDT",
            "TURBO": "TURBOUSDT", "MYRO": "MYROUSDT", "DEGEN": "DEGENUSDT",
            "WLD": "WLDUSDT", "ARKM": "ARKMUSDT", "AIXBT": "AIXBTUSDT",
            "AI16Z": "AI16ZUSDT", "ZEREBRO": "ZEREBROUSDT", "LUNC": "LUNCUSDT",
            "LUNA": "LUNAUSDT", "FTT": "FTTUSDT", "COTI": "COTIUSDT",
            "BEAM": "BEAMUSDT", "KAS": "KASUSDT", "INJ": "INJUSDT",
            "RUNE": "RUNEUSDT", "STX": "STXUSDT", "CHZ": "CHZUSDT",
            "GALA": "GALAUSDT", "ROSE": "ROSEUSDT", "ZIL": "ZILUSDT",
            "ONE": "ONEUSDT", "HOT": "HOTUSDT", "IOST": "IOSTUSDT",
            "DENT": "DENTUSDT", "CVC": "CVCUSDT", "MTL": "MTLUSDT",
            "OGN": "OGNUSDT", "REEF": "REEFUSDT", "CELR": "CELRUSDT",
            "SKL": "SKLUSDT", "RLC": "RLCUSDT", "NKN": "NKNUSDT",
            "STMX": "STMXUSDT", "KAVA": "KAVAUSDT", "BAND": "BANDUSDT",
            "YFI": "YFIUSDT", "UMA": "UMAUSDT", "BAL": "BALUSDT",
            "YFII": "YFIIUSDT", "TRB": "TRBUSDT", "LPT": "LPTUSDT",
            "API3": "API3USDT", "AUDIO": "AUDIOUSDT", "BLZ": "BLZUSDT",
            "C98": "C98USDT", "DUSK": "DUSKUSDT", "BEL": "BELUSDT",
            "FLM": "FLMUSDT", "SC": "SCUSDT", "XEM": "XEMUSDT",
            "QTUM": "QTUMUSDT", "ONT": "ONTUSDT", "NEO": "NEOUSDT",
            "GAS": "GASUSDT", "ONG": "ONGUSDT", "IOST": "IOSTUSDT",
            "VITE": "VITEUSDT", "PERL": "PERLUSDT", "TOMO": "TOMOUSDT",
            "WAN": "WANUSDT", "FUN": "FUNUSDT", "LINA": "LINAUSDT",
            "STPT": "STPTUSDT", "JST": "JSTUSDT", "SUN": "SUNUSDT",
            "BTT": "BTTUSDT", "WIN": "WINUSDT", "ANKR": "ANKRUSDT",
            "FET": "FETUSDT", "AGIX": "AGIXUSDT", "OCEAN": "OCEANUSDT",
            "NMR": "NMRUSDT", "ANT": "ANTUSDT", "BNT": "BNTUSDT",
            "BTS": "BTSUSDT", "LSK": "LSKUSDT", "STEEM": "STEEMUSDT",
            "SBD": "SBDUSDT", "HIVE": "HIVEUSDT", "DGB": "DGBUSDT",
            "XVG": "XVGUSDT", "NMC": "NMCUSDT", "PPC": "PPCUSDT",
            "NVC": "NVCUSDT", "VTC": "VTCUSDT", "FTC": "FTCUSDT",
            "ZEN": "ZENUSDT", "XZC": "XZCUSDT", "BCD": "BCDUSDT",
            "BTG": "BTGUSDT", "BCHA": "BCHAUSDT", "BSV": "BSVUSDT",
            "RUB": "RUBUSDT", "UAH": "UAHUSDT", "TRY": "TRYUSDT",
            "EUR": "EURUSDT", "GBP": "GBPUSDT", "AUD": "AUDUSDT",
            "BRL": "BRLUSDT", "CAD": "CADUSDT", "CHF": "CHFUSDT",
            "MXN": "MXNUSDT", "ARS": "ARSUSDT", "CLP": "CLPUSDT",
            "COP": "COPUSDT", "PEN": "PENUSDT", "NGN": "NGNUSDT",
            "ZAR": "ZARUSDT", "KES": "KESUSDT", "GHS": "GHSUSDT",
            "UGX": "UGXUSDT", "TZS": "TZSUSDT", "ETB": "ETBUSDT",
        }
